...
class Iface(object):
    ...
    def rempve_user(self, user, info):
        """
        Parameters:
         - user
         - info
...
class Client(Iface):
    ...
    def rempve_user(self, user, info):
        ...
        """
        self.send_rempve_user(user, info)
        return self.recv_rempve_user()

    def send_rempve_user(self, user, info):
        self._oprot.writeMessageBegin('rempve_user', TMessageType.CALL, self._seqid)
        args = rempve_user_args()
        args.user = user
        args.info = info
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_rempve_user(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = rempve_user_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "rempve_user failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["rempve_user"] = Processor.process_rempve_user
    ...
    def process_rempve_user(self, seqid, iprot, oprot):
        args = rempve_user_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = rempve_user_result()
        try:
            result.success = self._handler.rempve_user(args.user, args.info)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("rempve_user", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class rempve_user_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('rempve_user_args')
        if self.user is not None:
            oprot.writeFieldBegin('user', TType.STRUCT, 1)
            self.user.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(rempve_user_args)
rempve_user_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'user', [User, None], None, ),  # 1
    (2, TType.STRING, 'info', 'UTF8', None, ),  # 2
)
...
class rempve_user_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('rempve_user_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(rempve_user_result)
rempve_user_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
